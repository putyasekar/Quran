...
//        setContentView(android.R.attr.layout.activity_masjid);
//
//        toolbar = findViewById(android.R.attr.id.toolbar_masjid);
//
...
//
//        SupportMapFragment fragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(android.R.attr.id.fMap);
...
//                BitmapDescriptor pinDrop = BitmapDescriptorFactory.fromResource(android.R.attr.drawable.ic_place);
//
